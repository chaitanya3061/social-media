...
describe('SharingDialog widget - ShareBlock component', () => {
  ...
  const getShareBlockComponent = props => {
    if (!shallowShareBlockComponent) {
      shallowShareBlockComponent = shallow( /*#__PURE__*/React.createElement(ShareBlock, props));
    }
  ...
  it('renders the Autocomplete component ', () => expect(getShareBlockComponent(props).find(Autocomplete)).toHaveLength(1));
  it('renders the AccessSelect component', () => expect(getShareBlockComponent(props).find(AccessSelect)).toHaveLength(1));
