...
import { defaultSharingSettings, convertAccessToConstant, convertConstantToAccess } from './sharing-constants.js';
const query = {
  sharing: {
    resource: 'sharing',
    params: ({
...
export const SharingDialog = ({
  ...
  useEffect(() => {
    if (data !== null && data !== void 0 && data.sharing) {
      ...
      updateSharingSettings(prevState => ({ ...prevState,
        ...
        external: convertAccessToConstant(data.sharing.object.externalAccess),
        public: convertAccessToConstant(data.sharing.object.publicAccess),
  ...
  return /*#__PURE__*/React.createElement(Modal, {
    ...
    position: "top",
    onClose: onClose
  }, /*#__PURE__*/React.createElement(ModalTitle, null, sharingSettings.name ? i18n.t('Sharing and access: {{- objectName}}', {
    objectName: sharingSettings.name,
    nsSeparator: '|'
  }) : i18n.t('Sharing and access')), /*#__PURE__*/React.createElement(ModalContent, null, type === 'dashboard' ? /*#__PURE__*/React.createElement(DashboardSharingContent, {
    sharingSettings: sharingSettings,
    onAdd: onAdd,
    onChange: onChange,
    onRemove: onRemove
  }) : /*#__PURE__*/React.createElement(DefaultSharingContent, {
    sharingSettings: sharingSettings,
    onAdd: onAdd,
    onChange: onChange,
    onRemove: onRemove
