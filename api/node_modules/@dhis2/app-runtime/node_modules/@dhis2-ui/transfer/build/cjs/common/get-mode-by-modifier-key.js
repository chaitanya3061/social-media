...
const getModeByModifierKey = ({
  ...
  if (moreThanOneKeyPressed !== 1) return _modes.REPLACE_MODE;
  if (altKey || ctrlKey || metaKey) return _modes.ADD_MODE;
  if (shiftKey) return _modes.RANGE_MODE; // default to replace mode
