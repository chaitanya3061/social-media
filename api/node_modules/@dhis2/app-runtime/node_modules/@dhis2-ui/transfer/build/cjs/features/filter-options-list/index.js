...
(0, _steps.Then)('the same options should be shown', () => {
  cy.all(() => cy.get('@firstCaseOptions'), () => cy.get('{transfer-sourceoptions} {transferoption}')).should(([$firstCaseOptions, $secondCaseOptions]) => {
    const firstCaseOptions = $firstCaseOptions.toArray().map(_common.extractOptionFromElement);
    const secondCaseOptions = $secondCaseOptions.toArray().map(_common.extractOptionFromElement);
