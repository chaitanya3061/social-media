...
describe('validator: createCharacterLengthRange', () => {
  ...
  (0, _testHelpers.allowsEmptyValues)(betweenSixAndTenChars);
  describe('allows within-range strings', () => {
    (0, _testHelpers.testValidatorValues)(betweenSixAndTenChars, undefined, ['abcdef', // 6
    'abcdefgh', 'abcdefghij' // 10
    ]);
  });
  describe('rejects non-string values', () => {
    (0, _testHelpers.testValidatorValues)(betweenSixAndTenChars, inValidMsg, [true, 3, {}, [], () => {}]);
  });
  describe('rejects out-of-range strings', () => {
    (0, _testHelpers.testValidatorValues)(betweenSixAndTenChars, inValidMsg, ['a', 'abcde', // 5
    'abcdefghijk', // 11
