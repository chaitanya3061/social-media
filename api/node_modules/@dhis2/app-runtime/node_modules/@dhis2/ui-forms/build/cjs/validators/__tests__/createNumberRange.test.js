...
describe('validator: createNumberRange', () => {
  ...
  (0, _testHelpers.allowsEmptyValues)(betweenSixAndTen);
  describe('allows floats, integers and string representations of numbers', () => {
    (0, _testHelpers.testValidatorValues)(betweenSixAndTen, undefined, [7, 7.1, 0.71e1, '7', '7.1']);
  });
  describe('allows within-range numbers', () => {
    (0, _testHelpers.testValidatorValues)(betweenSixAndTen, undefined, [6, 8, 10, 9.999999, 6.000001]);
  });
  describe('rejects non-numerical values', () => {
    (0, _testHelpers.testValidatorValues)(betweenSixAndTen, errorMessage, ['test', true, {}, [], () => {}]);
  });
  describe('rejects out-of-range numbers', () => {
    (0, _testHelpers.testValidatorValues)(betweenSixAndTen, errorMessage, [3, 5, 5.999999, 10.000001, 1000000]);
  });
});