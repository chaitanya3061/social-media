...
describe('validator: dhis2Password', () => {
  (0, _testHelpers.allowsEmptyValues)(_dhis2Password.dhis2Password);
  ...
  describe('rejects value types other than string', () => {
    (0, _testHelpers.testValidatorValues)(_dhis2Password.dhis2Password, _dhis2Password.errorMessages.notString, [true, 3, {}, [], () => {}]);
  });
