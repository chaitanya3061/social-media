...
describe('validator: createMinNumber', () => {
  ...
  describe('allows numbers equal to or greater than the lower bound', () => {
    (0, _testHelpers.testValidatorValues)(atLeastSix, undefined, [6, 6.00001, 1000000]);
  });
  describe('rejects numbers below the lower bound', () => {
    (0, _testHelpers.testValidatorValues)(atLeastSix, errorMessage, [-10000, 0, 1, 5.999999]);
  });
});