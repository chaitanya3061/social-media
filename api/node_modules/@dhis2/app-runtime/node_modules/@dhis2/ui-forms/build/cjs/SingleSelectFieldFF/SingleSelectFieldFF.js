...
const SingleSelectFieldFF = ({
  ...
  return /*#__PURE__*/_react.default.createElement(_uiWidgets.SingleSelectField, _extends({}, rest, {
    name: input.name,
  ...
  }), options.map(option => /*#__PURE__*/_react.default.createElement(_uiCore.SingleSelectOption, _extends({
    key: option.value
  }, option))));
};
