...
describe('validator: email', () => {
  (0, _testHelpers.allowsEmptyValues)(_email.email);
  describe('allows valid email addresses', () => {
    /*
     * Items that have been commented out below are FALSELY REJECTED by the chosen regex
     */
    (0, _testHelpers.testValidatorValues)(_email.email, undefined, ['email@example.com', 'firstname.lastname@example.com', 'email@subdomain.example.com', 'firstname+lastname@example.com', // 'email@123.123.123.123',
  ...
  describe('rejects invalid email addresses', () => {
     ...
     */
    (0, _testHelpers.testValidatorValues)(_email.email, _email.invalidEmailMessage, ['plainaddress', '#@%^%#$@#$@#.com', '@example.com', 'Joe Smith <email@example.com>', 'email.example.com', 'email@example@example.com', '.email@example.com', 'email.@example.com', 'email..email@example.com',
    /*
