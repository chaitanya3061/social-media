...
const MultiSelectFieldFF = ({
  ...
  return /*#__PURE__*/_react.default.createElement(_uiWidgets.MultiSelectField, _extends({}, rest, {
    name: input.name,
  ...
  }), options.map(option => /*#__PURE__*/_react.default.createElement(_uiCore.MultiSelectOption, _extends({
    key: option.value
  }, option))));
};
