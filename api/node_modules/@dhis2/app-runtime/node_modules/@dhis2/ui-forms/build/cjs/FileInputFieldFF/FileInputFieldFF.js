...
const FileInputFieldFF = ({
  ...
  return /*#__PURE__*/_react.default.createElement(_uiWidgets.FileInputField, _extends({}, rest, {
  ...
  }), files.map(file => /*#__PURE__*/_react.default.createElement(_uiCore.FileListItem, {
    key: file.name,
    label: file.name,
