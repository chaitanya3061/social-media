...
var _parseServerVersion = require("../utils/parseServerVersion.js");
...
const ServerVersionProvider = ({
  ...
  (0, _react.useEffect)(() => {
    ...
    const request = (0, _api.get)(`${url}/api/system/info`);
  ...
  if (error) {
    return /*#__PURE__*/_react.default.createElement(_LoginModal.LoginModal, null);
  }
