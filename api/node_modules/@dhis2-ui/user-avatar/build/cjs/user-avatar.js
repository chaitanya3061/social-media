...
const UserAvatar = ({
  ...
  "data-test": dataTest,
  className: "jsx-3366500546" + " " + ((0, _classnames.default)(className, {
    extrasmall,
    small,
    medium,
    large,
...
}, avatarId ? /*#__PURE__*/_react.default.createElement(_imageAvatar.ImageAvatar, {
  avatarId: avatarId,
  dataTest: `${dataTest}-image`
}) : /*#__PURE__*/_react.default.createElement(_textAvatar.TextAvatar, {
  name: name,
